...
function NavBar() {
  ...
  // Close menu when the menu button is hidden (resize)
  useEffect(() => {
    function handleResize() {
      if (window.innerWidth >= 1280) {
        // XL screens or larger
        setIsMenuOpen(false);
      }
    }
  ...
  return (
    <div className="w-full h-full">
      <header className="relative flex justify-between items-center text-black py-4 px-8 md:px-32 bg-white drop-shadow-xs">
        <a href="">
          <img
            src={Logo}
            alt="Logo"
